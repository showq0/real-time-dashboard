...
async function consumeStream() {
  ...
  while (true) {
    ...
    if (metric.time - win.firstMetricTime >= 15 * 60) {
      ...
      pool.query(
        'INSERT INTO metrics_15min (client_id, window_start, cpu_avg, cpu_max, cpu_min, memory_avg, memory_max, memory_min) VALUES ($1,$2,$3,$4,$5,$6,$7,$8)',
